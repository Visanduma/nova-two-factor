        ...
        <div class="">
          ...
          <div v-else class="">
            ...
            <div class="tw-mb-4 tw-border-dashed tw-border-2 tw-border-light-blue dark:border-gray-500 tw-p-4 tw-rounded-lg tw-text-center tw-bg-gray-50 dark:bg-gray-700">
              ...
              <a class="tw-text-blue-700" @click.prevent="downloadAsText('recover_code.txt', twofa.recovery)" href="#">{{ __('Download') }}</a>
            </div>


            <span class="tw-bg-gray-100 tw-text-gray-800 tw-text-xs tw-font-semibold tw-mr-2 tw-px-2.5 tw-py-0.5 tw-rounded ">{{ __('Step 02') }}</span>
